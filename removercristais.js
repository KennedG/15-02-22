...
const db = require("quick.db");
      ...
      return message.reply(
        "<a:Negado:928462860961599590> Apenas o criador do bot pode utilizar esse comando!")
        ...
        if (args[0] > 10000) return message.channel.send("**❌ Não é possível remover esse tanto de valor!**")
        db.subtract(`cristais_${user.id}`, args[1])
        

        let moneyEmbed = new MessageEmbed()
            .setColor("WHITE")
            .setDescription(`✅ Removido ${args[1]} Cristais`);
