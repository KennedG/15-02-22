                    ...
                    return message.author.send(`<@${message.author.id}>\nPor último insira o prefixo do seu bot.\n**\`(ATT: Pode conter até 2 caractéres)\`**`).then(async (msg3) => {
                      ...
                      .on('collect', pref => {
                        ...
                        if(prefbot.length <= 2) {
                          ...
                          client.channels.cache.get("921399793299910726").send(EmbedForm)
